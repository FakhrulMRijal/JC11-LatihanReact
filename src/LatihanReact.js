...
import { Table, Input, Button, Dropdown, DropdownItem, DropdownToggle, DropdownMenu } from 'reactstrap';
...
class Home extends Component{
    ...
    renderDropDown = () => {
        return this.state.data.map((val) => 
            (<DropdownItem key={val.id}>{val.first_name}</DropdownItem>)
        )
    }
